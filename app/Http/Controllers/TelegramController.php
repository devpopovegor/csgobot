...
//        $curl_response = json_decode($curl_response);
	    $csmoney_items = collect(json_decode($curl_response)->items);
//	    $csmoney_items = $csmoney_items->where('custom_market_name', '=', '★ Karambit | Doppler (Factory New)');
        dd($csmoney_items->where('name', '=', '★ StatTrak™ Karambit | Autotronic (Minimal Wear)'));

//	    dd($csmoney_items->where('m', '=', '★ Karambit | Marble Fade'));
